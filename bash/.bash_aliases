...
alias dxscw='docker exec -it sls_checker-backend bash'
alias dxscdb='docker exec -it sls_checker-postgres bash'
...
alias dxplw='docker exec -it plates-backend bash'
alias dxpldb='docker exec -it plates-postgres bash'
alias dxpw='docker exec -it passport-backend bash'
alias dxpdb='docker exec -it passport-postgres bash'
alias dxprw='docker exec -it projects-backend bash'
alias dxprdb='docker exec -it projects-postgres bash'
...
alias dxcfpw='docker exec -it crystalfarm-backend bash'
alias dxcfpdb='docker exec -it crystalfarm-postgres bash'
alias dxdw='docker exec -it deposition-backend bash'
alias dxddb='docker exec -it deposition-postgres bash'
alias dxhw='docker exec -it --user root hexagods bash'
alias dxpiw='docker exec -it pins-backend bash'
alias dxtw='docker exec -it tms-backend bash'
alias dxtdb='docker exec -it tms-postgres bash'
alias dxsw='docker exec -it screens-backend bash'
alias dxsdb='docker exec -it screens-postgres bash'
alias dxpow='docker exec -it portal-backend bash'
alias dxpodb='docker exec -it portal-postgres bash'
