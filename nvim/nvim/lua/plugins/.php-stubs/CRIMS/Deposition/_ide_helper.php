...
namespace Illuminate\Support\Facades {
    ...
    class Auth {
         ...
         *
         * @return \App\Models\DB_Passport\ChiefUser|null 
         * @static 
         */
         ...
         *
         * @return \App\Models\DB_Passport\ChiefUser 
        ...
        public static function macro($name, $macro)
        {
            \Illuminate\Auth\TokenGuard::macro($name, $macro);
        }
        ...
        public static function mixin($mixin, $replace = true)
        {
            \Illuminate\Auth\TokenGuard::mixin($mixin, $replace);
        }
        ...
        public static function hasMacro($name)
        {
            return \Illuminate\Auth\TokenGuard::hasMacro($name);
        }
